...
class Multicase_StatusDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Multicase_Status> _instance;
...
static void InitDefaultsscc_info_Multicase_Status_zss_5fcmd_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::ZSS::New::_Multicase_Status_default_instance_;
    new (ptr) ::ZSS::New::Multicase_Status();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::ZSS::New::Multicase_Status::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Multicase_Status_zss_5fcmd_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Multicase_Status_zss_5fcmd_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_zss_5fcmd_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::ZSS::New::Multicase_Status, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::ZSS::New::Multicase_Status, ip_),
  PROTOBUF_FIELD_OFFSET(::ZSS::New::Multicase_Status, uuid_),
  PROTOBUF_FIELD_OFFSET(::ZSS::New::Multicase_Status, team_),
  PROTOBUF_FIELD_OFFSET(::ZSS::New::Multicase_Status, robot_id_),
  PROTOBUF_FIELD_OFFSET(::ZSS::New::Multicase_Status, battery_),
  PROTOBUF_FIELD_OFFSET(::ZSS::New::Multicase_Status, capacitance_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 6, -1, sizeof(::ZSS::New::Multicase_Status)},
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::ZSS::New::_Multicase_Status_default_instance_),
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_zss_5fcmd_2eproto_sccs[5] = {
  &scc_info_Multicase_Status_zss_5fcmd_2eproto.base,
  &scc_info_Robot_Command_zss_5fcmd_2eproto.base,
  &scc_info_Robot_Status_zss_5fcmd_2eproto.base,
...
void Multicase_Status::InitAsDefaultInstance() {
}
class Multicase_Status::_Internal {
 public:
};

Multicase_Status::Multicase_Status(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:ZSS.New.Multicase_Status)
}
Multicase_Status::Multicase_Status(const Multicase_Status& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:ZSS.New.Multicase_Status)
}

void Multicase_Status::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Multicase_Status_zss_5fcmd_2eproto.base);
  ip_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  uuid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
Multicase_Status::~Multicase_Status() {
  // @@protoc_insertion_point(destructor:ZSS.New.Multicase_Status)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void Multicase_Status::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  ip_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  uuid_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void Multicase_Status::ArenaDtor(void* object) {
  Multicase_Status* _this = reinterpret_cast< Multicase_Status* >(object);
  (void)_this;
}
void Multicase_Status::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void Multicase_Status::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const Multicase_Status& Multicase_Status::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Multicase_Status_zss_5fcmd_2eproto.base);
  return *internal_default_instance();
}


void Multicase_Status::Clear() {
// @@protoc_insertion_point(message_clear_start:ZSS.New.Multicase_Status)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* Multicase_Status::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "ZSS.New.Multicase_Status.ip"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string uuid = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "ZSS.New.Multicase_Status.uuid"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // .ZSS.New.Team team = 3;
...
::PROTOBUF_NAMESPACE_ID::uint8* Multicase_Status::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:ZSS.New.Multicase_Status)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:ZSS.New.Multicase_Status)
  return target;
}

size_t Multicase_Status::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:ZSS.New.Multicase_Status)
  size_t total_size = 0;
...
void Multicase_Status::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:ZSS.New.Multicase_Status)
  GOOGLE_DCHECK_NE(&from, this);
  const Multicase_Status* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Multicase_Status>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:ZSS.New.Multicase_Status)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:ZSS.New.Multicase_Status)
    MergeFrom(*source);
  }
}

void Multicase_Status::MergeFrom(const Multicase_Status& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:ZSS.New.Multicase_Status)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void Multicase_Status::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:ZSS.New.Multicase_Status)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Multicase_Status::CopyFrom(const Multicase_Status& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:ZSS.New.Multicase_Status)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Multicase_Status::IsInitialized() const {
  return true;
}

void Multicase_Status::InternalSwap(Multicase_Status* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  ip_.Swap(&other->ip_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  uuid_.Swap(&other->uuid_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Multicase_Status, capacitance_)
      + sizeof(Multicase_Status::capacitance_)
      - PROTOBUF_FIELD_OFFSET(Multicase_Status, team_)>(
          reinterpret_cast<char*>(&team_),
          reinterpret_cast<char*>(&other->team_));
}

::PROTOBUF_NAMESPACE_ID::Metadata Multicase_Status::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::ZSS::New::Multicase_Status* Arena::CreateMaybeMessage< ::ZSS::New::Multicase_Status >(Arena* arena) {
  return Arena::CreateMessageInternal< ::ZSS::New::Multicase_Status >(arena);
}
