...
namespace ZSS {
namespace New {
class Multicase_Status;
class Multicase_StatusDefaultTypeInternal;
extern Multicase_StatusDefaultTypeInternal _Multicase_Status_default_instance_;
class Robot_Command;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::ZSS::New::Multicase_Status* Arena::CreateMaybeMessage<::ZSS::New::Multicase_Status>(Arena*);
...
class Multicase_Status PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ZSS.New.Multicase_Status) */ {
 public:
  inline Multicase_Status() : Multicase_Status(nullptr) {};
  virtual ~Multicase_Status();

  Multicase_Status(const Multicase_Status& from);
  Multicase_Status(Multicase_Status&& from) noexcept
    : Multicase_Status() {
    *this = ::std::move(from);
  }

  inline Multicase_Status& operator=(const Multicase_Status& from) {
    CopyFrom(from);
    return *this;
  }
  inline Multicase_Status& operator=(Multicase_Status&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const Multicase_Status& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Multicase_Status* internal_default_instance() {
    return reinterpret_cast<const Multicase_Status*>(
               &_Multicase_Status_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(Multicase_Status& a, Multicase_Status& b) {
    a.Swap(&b);
  }
  inline void Swap(Multicase_Status* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(Multicase_Status* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline Multicase_Status* New() const final {
    return CreateMaybeMessage<Multicase_Status>(nullptr);
  }

  Multicase_Status* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Multicase_Status>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const Multicase_Status& from);
  void MergeFrom(const Multicase_Status& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Multicase_Status* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ZSS.New.Multicase_Status";
  }
  protected:
  explicit Multicase_Status(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:ZSS.New.Multicase_Status)
 private:
  class _Internal;
...
//  friend class ::GrSim_Client_Example
...
// string ip = 1;
inline void Multicase_Status::clear_ip() {
  ip_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& Multicase_Status::ip() const {
  // @@protoc_insertion_point(field_get:ZSS.New.Multicase_Status.ip)
  return _internal_ip();
}
inline void Multicase_Status::set_ip(const std::string& value) {
  _internal_set_ip(value);
  // @@protoc_insertion_point(field_set:ZSS.New.Multicase_Status.ip)
}
inline std::string* Multicase_Status::mutable_ip() {
  // @@protoc_insertion_point(field_mutable:ZSS.New.Multicase_Status.ip)
  return _internal_mutable_ip();
}
inline const std::string& Multicase_Status::_internal_ip() const {
  return ip_.Get();
}
inline void Multicase_Status::_internal_set_ip(const std::string& value) {
  
  ip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Multicase_Status::set_ip(std::string&& value) {
  
  ip_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ZSS.New.Multicase_Status.ip)
}
inline void Multicase_Status::set_ip(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  ip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ZSS.New.Multicase_Status.ip)
}
inline void Multicase_Status::set_ip(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:ZSS.New.Multicase_Status.ip)
}
inline std::string* Multicase_Status::_internal_mutable_ip() {
  
  return ip_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Multicase_Status::release_ip() {
  // @@protoc_insertion_point(field_release:ZSS.New.Multicase_Status.ip)
  return ip_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Multicase_Status::set_allocated_ip(std::string* ip) {
  if (ip != nullptr) {
  ...
  ip_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ip,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ZSS.New.Multicase_Status.ip)
}
inline std::string* Multicase_Status::unsafe_arena_release_ip() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ZSS.New.Multicase_Status.ip)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return ip_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Multicase_Status::unsafe_arena_set_allocated_ip(
    std::string* ip) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (ip != nullptr) {
  ...
  ip_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ip, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ZSS.New.Multicase_Status.ip)
}

// string uuid = 2;
inline void Multicase_Status::clear_uuid() {
  uuid_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& Multicase_Status::uuid() const {
  // @@protoc_insertion_point(field_get:ZSS.New.Multicase_Status.uuid)
  return _internal_uuid();
}
inline void Multicase_Status::set_uuid(const std::string& value) {
  _internal_set_uuid(value);
  // @@protoc_insertion_point(field_set:ZSS.New.Multicase_Status.uuid)
}
inline std::string* Multicase_Status::mutable_uuid() {
  // @@protoc_insertion_point(field_mutable:ZSS.New.Multicase_Status.uuid)
  return _internal_mutable_uuid();
}
inline const std::string& Multicase_Status::_internal_uuid() const {
  return uuid_.Get();
}
inline void Multicase_Status::_internal_set_uuid(const std::string& value) {
  
  uuid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Multicase_Status::set_uuid(std::string&& value) {
  
  uuid_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ZSS.New.Multicase_Status.uuid)
}
inline void Multicase_Status::set_uuid(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  uuid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ZSS.New.Multicase_Status.uuid)
}
inline void Multicase_Status::set_uuid(const char* value,
    size_t size) {
  ...
  uuid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ZSS.New.Multicase_Status.uuid)
}
inline std::string* Multicase_Status::_internal_mutable_uuid() {
  
  return uuid_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Multicase_Status::release_uuid() {
  // @@protoc_insertion_point(field_release:ZSS.New.Multicase_Status.uuid)
  return uuid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Multicase_Status::set_allocated_uuid(std::string* uuid) {
  if (uuid != nullptr) {
  ...
  uuid_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), uuid,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ZSS.New.Multicase_Status.uuid)
}
inline std::string* Multicase_Status::unsafe_arena_release_uuid() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ZSS.New.Multicase_Status.uuid)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return uuid_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Multicase_Status::unsafe_arena_set_allocated_uuid(
    std::string* uuid) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (uuid != nullptr) {
  ...
  uuid_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      uuid, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ZSS.New.Multicase_Status.uuid)
}

// .ZSS.New.Team team = 3;
inline void Multicase_Status::clear_team() {
  team_ = 0;
}
inline ::ZSS::New::Team Multicase_Status::_internal_team() const {
  return static_cast< ::ZSS::New::Team >(team_);
}
inline ::ZSS::New::Team Multicase_Status::team() const {
  // @@protoc_insertion_point(field_get:ZSS.New.Multicase_Status.team)
  return _internal_team();
}
inline void Multicase_Status::_internal_set_team(::ZSS::New::Team value) {
  
  team_ = value;
}
inline void Multicase_Status::set_team(::ZSS::New::Team value) {
  _internal_set_team(value);
  // @@protoc_insertion_point(field_set:ZSS.New.Multicase_Status.team)
}

// int32 robot_id = 4;
inline void Multicase_Status::clear_robot_id() {
  robot_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Multicase_Status::_internal_robot_id() const {
  return robot_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Multicase_Status::robot_id() const {
  // @@protoc_insertion_point(field_get:ZSS.New.Multicase_Status.robot_id)
  return _internal_robot_id();
}
inline void Multicase_Status::_internal_set_robot_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  robot_id_ = value;
}
inline void Multicase_Status::set_robot_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_robot_id(value);
  // @@protoc_insertion_point(field_set:ZSS.New.Multicase_Status.robot_id)
}

// float battery = 5;
inline void Multicase_Status::clear_battery() {
  battery_ = 0;
}
inline float Multicase_Status::_internal_battery() const {
  return battery_;
}
inline float Multicase_Status::battery() const {
  // @@protoc_insertion_point(field_get:ZSS.New.Multicase_Status.battery)
  return _internal_battery();
}
inline void Multicase_Status::_internal_set_battery(float value) {
  
  battery_ = value;
}
inline void Multicase_Status::set_battery(float value) {
  _internal_set_battery(value);
  // @@protoc_insertion_point(field_set:ZSS.New.Multicase_Status.battery)
}

// float capacitance = 6;
inline void Multicase_Status::clear_capacitance() {
  capacitance_ = 0;
}
inline float Multicase_Status::_internal_capacitance() const {
  return capacitance_;
}
inline float Multicase_Status::capacitance() const {
  // @@protoc_insertion_point(field_get:ZSS.New.Multicase_Status.capacitance)
  return _internal_capacitance();
}
inline void Multicase_Status::_internal_set_capacitance(float value) {
  
  capacitance_ = value;
}
inline void Multicase_Status::set_capacitance(float value) {
  _internal_set_capacitance(value);
  // @@protoc_insertion_point(field_set:ZSS.New.Multicase_Status.capacitance)
}
